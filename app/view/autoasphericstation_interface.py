...
class AutoAsphericStationInterface(GalleryInterface):
    """
    AutoAsphericStation GUI
    """
    def __init__(self, parent=None):
        t = Translator()
        super().__init__(
            title=t.autoAsphericStation,
            subtitle="Data Processing for Auto Aspheric Station",
            parent=parent
        )
    
        self.setObjectName('autoAsphericStationInterface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.AUTOASPHERICSTATION_INTERFACE.apply(self)
