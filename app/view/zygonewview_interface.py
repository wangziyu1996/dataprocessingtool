...
class ZygoNewviewInterface(GalleryInterface):
    """
    Zygo Newview GUI
    """
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=t.zygoNewView,
            subtitle="Data Processing for Zygo Newview",
            parent=parent
        )
    
        self.setObjectName('zygoNewviewInterface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.ZYGONEWVIEW_INTERFACE.apply(self)
