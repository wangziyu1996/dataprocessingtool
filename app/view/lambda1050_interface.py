...
class Lambda1050Interface(GalleryInterface):
    """
    Lambda 1050 GUI
    """
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=t.lambda1050,
            subtitle="Data Processing for Lambda 1050+",
            parent=parent
        )
    
        self.setObjectName('lambda1050Interface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.LAMBDA1050_INTERFACE.apply(self)
