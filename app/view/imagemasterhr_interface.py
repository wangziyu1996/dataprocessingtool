...
class ImageMasterHRInterface(GalleryInterface):
    """
    ImageMasterHR GUI
    """
    def __init__(self, parent=None):
        t = Translator()
        super().__init__(
            title=t.imageMasterHR,
            subtitle="Data Processing for ImageMasterHR",
            parent=parent
        )
    
        self.setObjectName('imageMasterHRInterface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.IMAGEMASTERHR_INTERFACE.apply(self)
