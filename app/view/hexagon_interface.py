...
class HexagonInterface(GalleryInterface):
    """
    Hexagon GUI
    """
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=t.hexagon,
            subtitle="Data Processing for Hexagon(CMM/OMM)",
            parent=parent
        )
    
        self.setObjectName('hexagonInterface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.HEXAGON_INTERFACE.apply(self)
