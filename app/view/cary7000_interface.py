...
class Cary7000Interface(GalleryInterface):
    """
    Cary 7000 GUI
    """
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=t.cary7000,
            subtitle="Data Processing for Cary 7000",
            parent=parent
        )
    
        self.setObjectName('cary7000Interface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.CARY7000_INTERFACE.apply(self)
