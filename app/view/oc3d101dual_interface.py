...
class OC3D101DualInterface(GalleryInterface):
    """
    OC 3D 101 Dual GUI
    """
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=t.oc3d101Dual,
            subtitle="Data Processing for OC 3D 101 Dual",
            parent=parent
        )
    
        self.setObjectName('oc3d101DualInterface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.OC3D101DUAL_INTERFACE.apply(self)
