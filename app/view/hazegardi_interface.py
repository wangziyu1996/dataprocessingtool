...
class HazeGardiInterface(GalleryInterface):
    """
    HazeGardi GUI
    """
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=t.hazeGardi,
            subtitle="Data Processing for Haze Gard i",
            parent=parent
        )
    
        self.setObjectName('hazeGardiInterface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.HAZEGARDI_INTERFACE.apply(self)
