...
class PolariscopeInterface(GalleryInterface):
    """
    Polariscope GUI
    """
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=t.polariscope,
            subtitle="Data Processing for Polariscope",
            parent=parent
        )
    
        self.setObjectName('polariscopeInterface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.POLARISCOPE_INTERFACE.apply(self)
