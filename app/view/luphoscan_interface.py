...
class LuphoscanInterface(GalleryInterface):
    """
    Luphoscan GUI
    """
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=t.luphoscan,
            subtitle="Data Processing for Luphoscan",
            parent=parent
        )
    
        self.setObjectName('luphoscanInterface')
        self.addExampleCard(
...
class PivotInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        StyleSheet.LUPHOSCAN_INTERFACE.apply(self)
